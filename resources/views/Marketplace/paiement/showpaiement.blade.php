                            ...
                            <div class="container py-5">
                                <div class="row d-flex justify-content-center my-4">
                                    <div class="col-md-4">
                                      <div class="card mb-4">
                                        <div class="card-header py-3">
                                          ...
                                          <h6 class="mb-0" style="text-align: center">Choisir le Mode de Paiement </h6>
                                        ...
                                        <div class="card-body">
                                         ...
                                         <form class="row d-flex justify-content-between align-items-center" method="POST" action="{{route('payment.create')}}">
                                             @csrf
                                             <input type="hidden" name="price" value="{{$total}}"/>
                                            <button type="submit" class="btn btn-warning fw-bolder"> 
                                            <img src="{{ asset('assetsMarketplace/images/pay-pal.png') }}"  width="20" height="40" alt="paypal"  /> Payer avec Paypal</button>     
                                        </form>
                                          ...
                                          <div class="card rounded-3 mb-4">
                                            <div class="card-body p-4">
                                                ...
                                                <form class="row d-flex justify-content-between align-items-center" method="POST" action="{{route('payment.createCheckoutSession') }}">
                                                    <input type="hidden" name="price" value="{{$total}}"/>
                                                    @csrf
 
                                            <button type="submit" class="btn btn-primary fw-bolder"> <img src="{{ asset('assetsMarketplace/images/stripe1.png') }}"  width="30" height="50" alt="stripe"  /> Payer avec Stripe</button>
                                                </form>  
                                            </div>
                                          </div>
                                          <!-- Single item -->
                                    ...
                                    <div class="col-md-4">
                                      <div class="card mb-4">
                                        <div class="card-header py-3">
                                          <h6 class="mb-0" style="text-align: center">Résumé</h6>
                                        </div>
                                        <div class="card-body">
