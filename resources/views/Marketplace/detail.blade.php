                                    ...
                                    <div class="register">
                                        ...
                                        @if(session()->has('client_hom'))
                                            ...
                                            @else
                                                ...
                                                <li>/</li>
                                                <li><a href="#modalRegister" data-bs-toggle="modal">Se connecter</a></li>
                                            @endif
                                        </ul>
                ...
                <div class="container">
                    <div class="header-property-detail">
                        <div class="content-top d-flex justify-content-between align-items-center">
                            <div class="box-name">
                                <h4 class="title link">{{$detaiLead->thematique->thematique}}</h4>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="single-property-element single-property-desc">
                                ...
                                <p class="body-2 text-variant-1">{{$detaiLead->description}}</p>
                            </div>
