        ...
        <div id="pagee" class="clearfix">
            ...
            <section class="flat-section flat-banner-about">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                            <h3> Bienvenue chez <br> Lead & Boost</h3>
                        </div>
                    ...
                    <div class="wrap-banner bg-surface">
                        <div class="box-left">
                            <div class="box-title">
                                ...
                                <h4 class="mt-4">Bienvenue sur LeadBoost! Rejoignez-nous dès maintenant!</h4>
                            </div>
                            <a href="{{route('get.marketplace')}}" class="tf-btn primary size-1">J'accède à la marketplace!</a>
                        </div>
                        <div class="box-right">
