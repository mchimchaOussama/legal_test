        ...
        <tr>
            <td align="center" style="padding: 30px;">
                <table width="500" cellpadding="0" cellspacing="0" border="0" style="background-color: white; box-shadow: 1px 1px 10px 2px rgba(0,0,0, 0.1);">
                    ...
                    <!-- Additional Info 
                    <tr>
                        <td align="center" style="font-size: 14px; color: #888888; padding: 10px 30px;">
                            Si vous n'avez pas demandé de réinitialisation de mot de passe, veuillez ignorer cet e-mail. Ce lien est valide pour 24 heures seulement.
                        </td>
                    </tr>
                    -->
                    <!-- Footer -->
