                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group" style="margin-bottom:10px">
                                                <label>commentaire Particulier</label>
                                                <textarea class="form-control" class="form-control @error('commentaireParticulier') is-invalid @enderror" placeholder="saisie commentaire Particulier" wire:model="commentaireParticulier" autocomplete="off" rows="5"></textarea>
                                                <span class="error">
                                                    @error("commentaireParticulier") {{$message}}  @enderror
                                                </span>
                                            </div>
                                        </div>
