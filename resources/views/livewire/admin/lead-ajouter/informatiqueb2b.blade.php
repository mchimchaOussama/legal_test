                                ...
                                <div class="form-wizard-body py-3">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group mb-1">
                                                <label>Langues</label>
                                                <select class="form-control @error('lange') is-invalid @enderror" wire:model="lange">
                                                    <option value="" selected>Langues</option>
                                                    <option value="informatiqueMW" >Informatique Marketing / Web Marketing</option>
                                                    <option Value="ComptabilitéG" >Comptabilité Gestion</option>
                                                    <option Value="siteInetrnet" >Création de site Internet</option>
                                                </select>
                                                <span class="error">
                                                    @error("lange") {{$message}}  @enderror
                                                </span>
                                            </div>
                                        </div>
