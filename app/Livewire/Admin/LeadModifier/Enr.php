...
class Enr extends Component
{
         ...
         /////// Prospect ////////
         public $nom, $prenom, $tel, $email, $civilite,$entreprise,$coutGaz,$coutElectrecite;
         ...
         ////////// Lead ////////////
         public $thematique,$fournisseurGaz, $fournisseurElectrecite, $modeConsommation,$activite,$gerant,$modeChauffage, $commentaireAuditeur, $mp3Bipe, $adresse_cache,$maison,$interetAmeliorationHabitat;
         ...
         public function mount($leadId)
         {
             ...
             $this->civilite = $this->prospect->civilite;
              ...
              $this->gerant = $this->lead->gerant;
              $this->coutGaz = $this->lead->coutGaz;
              $this->coutElectrecite = $this->lead->coutElectrecite;
              $this->activite = $this->lead->activite;
              ...
              $this->modeChauffage = $this->lead->modeChauffage;
              $this->commentaireAuditeur = $this->lead->commentaireAuditeur;
              $this->mp3Bipe = $this->lead->lienMp3Bip;
              $this->fournisseurElectrecite = $this->lead->fournisseurElectrecite;
              $this->entreprise = $this->lead->entreprise;
              $this->fournisseurGaz = $this->lead->fournisseurGaz;
         ...
         $new_lead->fournisseurElectrecite = $this->fournisseurElectrecite;
         $new_lead->entreprise = $this->entreprise;
         $new_lead->fournisseurGaz = $this->fournisseurGaz;
         // Save the lead
         $new_lead->save();
    ...
    {
        return view('livewire.admin.lead-modifier.enr',['thematique_array' => $this->thematique_array , 'departement_array' => $this->departement_array , 'ville_array'=>$this->ville_array]);
    }
}
