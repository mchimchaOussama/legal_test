...
class Index extends Component
{
        ...
        /////// Prospect ////////
        public $nom, $prenom, $tel, $email, $civilite,$salarie;
        ...
        public function mount($leadId)
        {
            ...
            $this->civilite = $this->prospect->civilite;
             ...
             $this->salarie = $this->lead->salarie;
             $this->interetAmeliorationHabitat = $this->lead->interetAmeliorationHabitat;
             $this->maison = $this->lead->maison;
        ...
        $new_lead->interetAmeliorationHabitat = $this->interetAmeliorationHabitat;
        $new_lead->maison = $this->maison;
        // Save the lead
        $new_lead->save();
    ...
    {
        return view('livewire.admin.lead-modifier.index',['thematique_array' => $this->thematique_array , 'departement_array' => $this->departement_array , 'ville_array'=>$this->ville_array]);
    }
}
