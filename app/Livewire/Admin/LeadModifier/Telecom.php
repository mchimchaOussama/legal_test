...
class Telecom extends Component
{
      ...
      /////// Prospect ////////
      public $nom, $prenom, $tel, $email, $civilite,$gerantNonSalarie,$nombreDeSalarie,$lange,$fonctionEntreprise,$operationActuel;
      ...
      ////////// Lead ////////////
      public $thematique, $modeConsommation, $commentaireAuditeur, $mp3Bipe, $adresse_cache,$maison,$interetAmeliorationHabitat,$DatChangementOperateur;
  
      ///////// Publicite /////////
      public $image, $prix, $adresse_reelle, $description,$nombreLineConcernees,$telephonFix ,$entreprise,$telephonMobile,$typeServicesRecherche;
      ...
      public function mount($leadId)
      {
          ...
          $this->civilite = $this->prospect->civilite;
           ...
           $this->nombreLineConcernees = $this->lead->nombreLineConcernees;
           ...
           $this->fonctionEntreprise = $this->lead->fonctionEntreprise;
           $this->operationActuel = $this->lead->operationActuel;
           $this->telephonFix = $this->lead->telephonFix;
           $this->entreprise = $this->lead->entreprise;
           $this->telephonMobile = $this->lead->telephonMobile;
           $this->typeServicesRecherche = $this->lead->typeServicesRecherche;
           $this->DatChangementOperateur = $this->lead->DatChangementOperateur;
          ...
          $this->validate(
              [
                ...
                //  'proprietaire'      =>  'required|in:oui,non',
                  ...
                  'telephonMobile' => 'required',
                  'typeServicesRecherche' => 'required',
                  'DatChangementOperateur' => 'required',
                      ///////// Publicite //////////
                  "prix"                => 'required|numeric',
                  "adresse_reelle"      => 'required',
                  'telephonFix' =>'required'
              ],
              [
      ...
      $new_lead->operationActuel = $this->operationActuel;
      ...
      $new_lead->fonctionEntreprise = $this->fonctionEntreprise;
      $new_lead->nombreLineConcernees = $this->nombreLineConcernees;
      $new_lead->telephonFix = $this->telephonFix;
      $new_lead->entreprise = $this->entreprise;
      $new_lead->telephonMobile = $this->telephonMobile;
      $new_lead->typeServicesRecherche = $this->typeServicesRecherche;
      $new_lead->DatChangementOperateur = $this->DatChangementOperateur;
      // Save the lead
      $new_lead->save();
    ...
    {
        return view('livewire.admin.lead-modifier.telecom',['thematique_array' => $this->thematique_array , 'departement_array' => $this->departement_array , 'ville_array'=>$this->ville_array]);
    }
}
