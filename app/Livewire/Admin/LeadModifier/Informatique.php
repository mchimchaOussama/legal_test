...
class Informatique extends Component
{
      ...
      /////// Prospect ////////
      public $nom, $prenom, $tel, $email, $civilite,$salarie,$datSalarie,$lange2;
      ...
      public function mount($leadId)
      {
          ...
          $this->civilite = $this->prospect->civilite;
           ...
           $this->datSalarie = $this->lead->datSalarie;
      ...
      $new_lead->datSalarie = $this->datSalarie;
      $new_lead->salarie = $this->salarie;
      $new_lead->lange2 = $this->lange2;
      // Save the lead
      $new_lead->save();
    ...
    {
        return view('livewire.admin.lead-modifier.informatique',['thematique_array' => $this->thematique_array , 'departement_array' => $this->departement_array , 'ville_array'=>$this->ville_array]);
    }
}
