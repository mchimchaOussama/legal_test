...
class Enr extends Component
{
  ...
  /////// Prospect ////////
  public $nom, $prenom, $tel, $email, $civilite,$entreprise,$activite,$gerant;
  
  /////// Appel /////////
  public $agent, $heure, $date, $disponibilite, $lienMp3, $commentaireAgent;

  //////// publication //////////
  public $ville,$modeChauffage,$coutGaz,$coutElectrecite,$fournisseurGaz,$fournisseurElectrecite, $departement, $code_postale, $proprietaire, $metrage, $adresse;

  ////////// Lead ////////////
  public $thematique, $modeConsommation, $commentaireAuditeur, $lienMp3bip, $adresse_cache;
  ...
  {
      $this->thematique_array  = Thematique::where('theme','enr')->get();
  ...
  public function ajouter_lead_step5()
  {
      ...
      Lead::create([
          ...
          'fournisseurElectrecite' => $this->fournisseurElectrecite,
          'fournisseurGaz' => $this->fournisseurGaz,
          'coutGaz' => $this->coutGaz,
          'coutElectrecite' => $this->coutElectrecite,
      ]);
      ...
      $this->reset(
                  "prix", "adresse_reelle",
                  "description", "thematique", "coutElectrecite", "commentaireAuditeur", "lienMp3bip", "adresse_cache",
                  "ville", "departement", "code_postale", "coutGaz", "fournisseurGaz", "adresse",
                  "agent", "heure", "date", "disponibilite", "lienMp3", "commentaireAgent",
                  "nom", "prenom", "tel", "email", "civilite",'fournisseurElectrecite','modeChauffage','gerant','activite','entreprise'
              );
    ...
    {
        return view('livewire.admin.lead-ajouter.enr',['thematique_array'=>$this->thematique_array,'departement_array'=>$this->departement_array,'ville_array'=>$this->ville_array]);
    }
}
