...
class Telecom extends Component
{
  ...
  /////// Prospect ////////
  public $nom, $prenom, $tel, $email, $civilite,$entreprise,$fonctionEntreprise;
  ...
  ////////// Lead ////////////
  public $thematique,$operationActuel,$DatChangementOperateur,$commentaireParticulier,$typeServicesRecherche,$telephonFix,$telephonMobile,$nombreLineConcernees, $modeConsommation, $commentaireAuditeur, $lienMp3bip, $adresse_cache;
  ...
  {
      $this->thematique_array  = Thematique::where('theme','telecom')->get();
  ...
  public function ajouter_lead_step5()
  {
      ...
      Lead::create([
          ...
          'entreprise'        => $this->cute($this->entreprise),
          'fonctionEntreprise' => $this->cute($this->fonctionEntreprise),
          'adressePostale'    => $this->cute($this->adresse),
          'thematique_id'     => $this->cute($this->thematique),
          'operationActuel'  => $this->cute($this->operationActuel),
          ...
          "nombreLineConcernees"   =>  $this->nombreLineConcernees,
          "telephonFix"   => $this->telephonFix,
          "telephonMobile"   => $this->telephonMobile,
          "typeServicesRecherche" => $this->typeServicesRecherche,
          "DatChangementOperateur"   => $this->DatChangementOperateur,
          "commentaireParticulier"   => $this->commentaireParticulier,
      ...
      $this->reset(
                  "prix", "adresse_reelle",
                  "description", "thematique", "commentaireParticulier", "commentaireAuditeur", "lienMp3bip", "adresse_cache",
                  "ville", "departement", "code_postale", "DatChangementOperateur", "typeServicesRecherche", "adresse",
                  "agent", "heure", "date", "disponibilite", "lienMp3", "commentaireAgent",
                  "nom", "prenom", "tel", "email", "civilite","telephonMobile","telephonFix","nombreLineConcernees","fonctionEntreprise","entreprise","operationActuel"
              );
    ...
    {
        return view('livewire.admin.lead-ajouter.telecom',['thematique_array'=>$this->thematique_array,'departement_array'=>$this->departement_array,'ville_array'=>$this->ville_array]);
    }
}
