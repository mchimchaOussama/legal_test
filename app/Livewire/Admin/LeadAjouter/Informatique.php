...
class Informatique extends Component
{
  ...
  /////// Prospect ////////
  public $nom, $prenom, $tel, $email, $civilite,$salarie,$datSalarie;
  ...
  ////////// Lead ////////////
  public $thematique, $modeConsommation,$lange2, $commentaireAuditeur, $lienMp3bip, $adresse_cache;
  ...
  {
    $this->thematique_array = Thematique::where('theme', 'formationB2C')->get();
  ...
  public function ajouter_lead_step1()
  {
      $this->validate(
          [
              ...
              'salarie'           => 'required|in:oui,non',
              'datSalarie'        => 'required|in:2,3',
  ...
  public function ajouter_lead_step5()
  {
      ...
      Lead::create([
          ...
          'salarie'      => $this->cute($this->salarie),
          'datSalarie'           => $this->cute($this->datSalarie),
          'adressePostale'    => $this->cute($this->adresse),
          'thematique_id'     => $this->cute($this->thematique),
          'lange2'  => $this->cute($this->lange2),
      ...
      $this->reset(
                  "prix", "adresse_reelle",
                  "description", "thematique", "salarie", "commentaireAuditeur", "lienMp3bip", "adresse_cache",
                  "ville", "departement", "code_postale", "datSalarie", "lange2", "adresse",
    ...
    {
        return view('livewire.admin.lead-ajouter.informatique',['thematique_array'=>$this->thematique_array,'departement_array'=>$this->departement_array,'ville_array'=>$this->ville_array]);
    }
}
